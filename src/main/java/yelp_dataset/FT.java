...
//Hashing using a set, linked list
//8 indicates sample code

/*exercise 2:
use this code to create a frequency table that
    ...
    public void add(String key) {
        ...
        while(e!=null){//while not at end of linked list
            if(key.equals(e.key)){//if find key already in linked list
                ...
                e.count++;//increments count of Node containing key
        ...
        Node newNode= new Node(key, 1, head);//new node's next points to head; newNode's count is 1
